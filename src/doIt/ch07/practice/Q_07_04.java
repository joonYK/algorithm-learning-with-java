...
/**
 * 클래스 IntSet에 대해 집합 s1과 집합 s2의 교집합을 복사하는 메서드,
 * 집합 s1과 집합 s2의 차집합을 복사하는 메서드를 작성.
 *
 * void intersection(IntSet s1, IntSet s2)    //s1과 s2의 교집합을 복사
 * void differenceOf(IntSet s1, IntSet s2)     //s1과 s2의 차집합을 복사
 *
 * */
public class Q_07_04 {
    static class IntSet {
    ...
    public static void main(String[] args) {
        Q_07_04.IntSet s1 = new Q_07_04.IntSet(5);
        Q_07_04.IntSet s2 = new Q_07_04.IntSet(5);
        Q_07_04.IntSet s3 = new Q_07_04.IntSet(5);
        Q_07_04.IntSet set = new Q_07_04.IntSet(5);
        ...
        System.out.println();
        System.out.println("set.differenceOf(s1, s3)");
        set.differenceOf(s1, s3);
        System.out.println("set : " + set);
    }
}
